...
use Horus\BackendBundle\Entity\Commercial;
use Horus\BackendBundle\Form\CommercialType;
use Horus\BackendBundle\Form\TagType;
...
class CommercialController extends Controller
{
    ...
    {
        return $this->render('HorusBackendBundle:Commercial:commercial.html.twig', array('commercial' => $id));
    }
    ...
    public function commercialsAction()
    {
        ...
        $commercials = $em->getRepository('HorusBackendBundle:Commercial')->findBy(array(), array('id' => "DESC"));
        ...
        return $this->render('HorusBackendBundle:Commercial:commercials.html.twig', array('commercials' => $pagination));
    }
    ...
    public function createcommercialAction()
    {
        ...
        return $this->render('HorusBackendBundle:Commercial:createcommercial.html.twig',
            array(
    ...
    public function editcommercialAction(Commercial $id)
    {
        ...
        return $this->render('HorusBackendBundle:Commercial:editcommercial.html.twig',
            array(
                'form' => $form->createView(),
                'commercial' => $id,
            )
