...
//        $this->email->send(null, 'HorusBackendBundle:Mails:welcome.html.twig', "Bienvenue sur Horus", 'julien@meetserious.com', null,
...
//        );
     ...
     * @return \Symfony\Component\HttpFoundation\Response
     */
    public function searchBarAction($word = null)
    {
        $form = $this->createForm(new SearchType(), null, array(
            'action' => $this->generateUrl('horus_search_avanced'),
            'method' => 'POST',
        ));

        return $this->render('HorusBackendBundle:Slots:search.html.twig',
    ...
    public function searchAction(Request $request)
    {
        ...
        return $this->render('HorusBackendBundle:Main:search.html.twig',
