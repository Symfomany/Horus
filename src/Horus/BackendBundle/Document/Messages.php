...
class Messages
{
     ...
     * Set parent
     *
     * @param Horus\BackendBundle\Document\Messages $parent
     * @return self
     */
    public function setParent(\Horus\BackendBundle\Document\Messages $parent)
    {
        $this->parent = $parent;
        return $this;
    }
     ...
     * Get parent
     *
     * @return Horus\BackendBundle\Document\Messages $parent
     */
